...
export default function SchemeDetailsPage() {
  ...
  const handleEligibilityChange = (field: keyof EligibilityType, value: string | null | string[]) => {
    setFormData({
      ...formData,
      eligibility: {
  ...
  const commonTags: string[] = [
    'poverty', 'direct-transfer', 'farmers', 'agriculture', 'rural',
    'employment', 'youth', 'skills', 'training', 'digital', 'literacy',
    'technology', 'startups', 'business', 'entrepreneurs', 'health',
    'insurance', 'medical', 'education', 'women', 'children'
  ]
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea 
                        id="description"
                        name="description"
                        value={isEditing ? formData.description : scheme.description}
                        onChange={handleChange}
                        disabled={!isEditing}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input 
                            ...
                            value={isEditing ? formData.eligibility.dob || "" : scheme.eligibility.dob || ""}
                            onChange={(e) => handleEligibilityChange('dob', e.target.value)}
                            disabled={!isEditing}
                          />
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          {isEditing ? (
                            <Select 
                              ...
                              onValueChange={(value) => handleEligibilityChange('gender', value)}
                            >
                              <SelectTrigger>
                        ...
                        <div className="space-y-2">
                          ...
                          <Input 
                            ...
                            value={isEditing ? formData.eligibility.state || "" : scheme.eligibility.state || ""}
                        ...
                        <div className="space-y-2">
                          ...
                          <Input 
                            ...
                            value={isEditing ? formData.eligibility.district || "" : scheme.eligibility.district || ""}
                            onChange={(e) => handleEligibilityChange('district', e.target.value)}
                            disabled={!isEditing}
                          />
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <Input 
                            ...
                            value={isEditing ? formData.eligibility.phone || "" : scheme.eligibility.phone || ""}
                            onChange={(e) => handleEligibilityChange('phone', e.target.value)}
                            disabled={!isEditing}
                          />
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <Input 
                            ...
                            type="email"
                            value={isEditing ? formData.eligibility.email || "" : scheme.eligibility.email || ""}
                        ...
                        <div className="space-y-2">
                          ...
                          <Input 
                            ...
                            value={isEditing ? formData.eligibility.caste || "" : scheme.eligibility.caste || ""}
                            onChange={(e) => handleEligibilityChange('caste', e.target.value)}
                            disabled={!isEditing}
                          />
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <Input 
                            ...
                            value={isEditing ? formData.eligibility.income || "" : scheme.eligibility.income || ""}
                          ...
                          <div className="flex flex-wrap gap-2 mt-2">
                            {commonTags.map((tag: string) => (
                              <div key={tag} className="flex items-center space-x-2">
                                <Checkbox 
                                  id={`tag-${tag}`}
                                  checked={formData.eligibility.tags.includes(tag)}
